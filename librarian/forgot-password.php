...
<head>
    ...
    <title>LMS || Librarian Password Reset</title>
...
<div class="wrap">
    ...
    <div class="page-body  animated slideInDown">
        ...
        <div class="logo">
            ...
            <h1 class="text-center font200">LMS</h1>
        </div>
        <div class="box">
            ...
            <div class="panel mb-none">
                <div class="panel-content bg-scale-0">
                    <form action="" method="POST">
                        <h4>Forgot your password?</h4> Type here Your email and check mail box
                        <div class="form-group mt-md">
                                <span class="input-with-icon">
                                        <input type="email" class="form-control" id="email" placeholder="Type here your accound email id">
