                ...
                <div class="row">
                  <div class="col-12">
                    <div class="pull-right">
                      <span class=" text-primary mr-3"  ><i class="fa fa-circle" ></i></span>
                        ...
                        <div class="UserPhotoView">
                            <div class="profile-photo">
                                <div class="imges">
                                  ...
                                  <?php } else {  ?>
                                    <img alt="User photo" class="img-thumbnail" src="../images/students/<?= $user['photo']; ?>">
                                <?php } ?>
                                </div>
                        ...
                        <div class="panel bg-scale-0 b-primary bt-sm mt-xl">
                            <div class="panel-content">
                                ...
                                <ul class="user-contact-info ph-sm">
                                    ...
                                    <li><b><i class="color-primary mr-sm fa fa-phone"></i></b> <?php echo $user['phoneno']; ?></li>
                    ...
                    <div class="col-md-6 col-lg-8">
                        <?php
                          ...
                          if (isset($_POST['update'])) {
                            ...
                            // echo $phone_number;
                            $Query = "UPDATE `students` SET `fname`='$fname', `lname`='$lname',`phoneno`='$phone_number',`address`='$address' WHERE `id` = '$id' ";
                        ...
                        <div class="your-info">
                          ...
                          <form action="" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group mt-md">
                                  <label class="label25" for="">Registration Number</label>
                                  <input type="number" class="form-control" <?php echo "disabled"; ?> value="<?php echo $user['reg']; ?>">
                              </div>

                              <div class="form-group mt-md">
                                  <label class="label25" for="">Roll Number</label>
                                  <input type="number" class="form-control" <?php echo "disabled"; ?> value="<?php echo $user['roll']; ?>">
                              </div>
                              <div class="form-group mt-md">
                              ...
                              <div class="form-group mt-md">
                                  ...
                                  <input type="text" name="phone_number" <?= $change=="disabled"? $change : ''; ?> class="form-control" value="<?php echo $user['phoneno']; ?>">
                              </div>
                              ...
                              <div class="form-group mt-md">
                                  <label class="label25" for="">Status</label>
                                  <input type="text" class="form-control" <?php echo "disabled"; ?> value="<?php echo "Active"; ?>">
                              </div>
